<template >
    <Transition v-show="isSidebarOpen" enter-class="transition-all transform duration-300 ease-in-out"
        enter-from-class="-translate-x-full opacity-0" enter-to-class="translate-x-0 opacity-100"
        leave-class="transition-all transform duration-300 ease-in-out" leave-from-class="translate-x-0 opacity-100"
        leave-to-class="-translate-x-full opacity-0" class="inset-y-0 z-10 flex-shrink-0 h-full relative"
        aria-label="Sidenav">
        <div class="h-full fixed w-full w-72 lg:w-2/12">
                        ...
                        <li>
                            <NuxtLink :to="item.to"
                                ...
                                <svg aria-hidden="true"
                                    ...
                                    <path :d="item.svg.paths[0]"></path>
                                    <path :d="item.svg.paths[1]"></path>
                                </svg>
                                <span class="flex-1 ml-3 whitespace-nowrap">{{item.title}}</span>
                                <span v-show="item.hasCounter"
                        ...
                        <li>
                            <NuxtLink :to="item.to"
                                ...
                                <svg aria-hidden="true"
                                    ...
                                    <path fill-rule="evenodd" :d="item.svg.paths[0]" clip-rule="evenodd"></path>
                                </svg>
                                <span class="flex-1 ml-3 whitespace-nowrap">{{item.title}}</span>
                                <span v-show="item.hasCounter"
                                    class="inline-flex justify-center items-center w-5 h-5 text-xs font-semibold rounded-full text-primary-800 bg-primary-100 dark:bg-primary-200 dark:text-primary-800">
            ...
            <div
                ...
                <a class="inline-flex justify-center p-2 text-gray-500 rounded cursor-pointer ">
                    <Switch v-model="darkTheme" :class="darkTheme ? 'bg-blue-600' : 'bg-gray-300'"
                        class="relative inline-flex h-6 w-11 items-center rounded-full">
                        <span class="sr-only">Enable notifications</span>
                        <span :class="darkTheme ? 'translate-x-6' : 'translate-x-1'"
                ...
                <div class="block md:hidden">
                    <Menu as="div" class="relative inline-block text-left">
                        <div>
                            ...
                            <MenuButton type="button" data-dropdown-toggle="language-dropdown"
                                class="inline-flex justify-center p-2 text-gray-500 rounded cursor-pointer dark:hover:text-white dark:text-gray-400 hover:text-gray-900 hover:bg-gray-100 dark:hover:bg-gray-600">
                                <svg aria-hidden="true" class="w-6 h-6" fill="currentColor" viewBox="0 0 60 60"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <g>
                    ...
                    c0.882,0.247,1.735,0.601,2.537,1.063C55.773,38.377,58,41.93,58,46C58,52.065,53.065,57,47,57z" />
                        ...
                        <transition enter-active-class="transition ease-out duration-100"
                            ...
                            <MenuItems
                                class="absolute bottom-0 left-0 z-10 mt-2 w-56 origin-top-right divide-y divide-gray-100 rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
                                <div class="py-1">
                                    <MenuItem v-slot="{ active }">
                                    <a href="#"
                                        :class="[active ? 'bg-gray-100 text-gray-900' : 'text-gray-700', 'block px-4 py-2 text-sm']">Profile</a>
                                    </MenuItem>
                                ...
                                <div class="py-1">
                                    <MenuItem v-slot="{ active }">
                                    <a href="#"
                                        :class="[active ? 'bg-gray-100 text-gray-900' : 'text-gray-700', 'block px-4 py-2 text-sm']">Share
                                        Profile</a>
                                    </MenuItem>
                                </div>
                                <div class="py-1">
...
const items = [
    {
        ...
        to: "/dashboard",
        svg: {
            paths: ["M13.5 16.875h3.375m0 0h3.375m-3.375 0V13.5m0 3.375v3.375M6 10.5h2.25a2.25 2.25 0 002.25-2.25V6a2.25 2.25 0 00-2.25-2.25H6A2.25 2.25 0 003.75 6v2.25A2.25 2.25 0 006 10.5zm0 9.75h2.25A2.25 2.25 0 0010.5 18v-2.25a2.25 2.25 0 00-2.25-2.25H6a2.25 2.25 0 00-2.25 2.25V18A2.25 2.25 0 006 20.25zm9.75-9.75H18a2.25 2.25 0 002.25-2.25V6A2.25 2.25 0 0018 3.75h-2.25A2.25 2.25 0 0013.5 6v2.25a2.25 2.25 0 002.25 2.25z"]
        },
        hasCounter: false,
        counter: 0
    },
