                ...
                <div class="w-full flex-none snap-center px-4 sm:px-6">
                    <div class="relative transform overflow-hidden rounded-2xl bg-gray-800 px-5 py-6">
                        ...
                        <div class="relative aspect-[366/729] relative mx-auto w-full max-w-[366px]">
                            ...
                            </svg><img alt="" src="/images/phone-frame.d4b6b62a.svg" width="366"
                                height="729" decoding="async" data-nimg="future"
            ...
            <div class="grid grid-cols-12 items-center gap-8 lg:gap-16 xl:gap-24">
                <div class="relative z-10 order-last col-span-6 space-y-6" role="tablist" aria-orientation="vertical">
                    <div class="relative rounded-2xl transition-colors hover:bg-gray-800/30">
                        <div class="absolute inset-0 bg-gray-800" data-projection-id="13"
                        ...
                        <div class="relative z-10 p-8"><svg viewBox="0 0 32 32" aria-hidden="true" class="h-8 w-8">
                            ...
                            <h3 class="mt-6 text-lg font-semibold text-white"><button
                                    class="text-left "
                                    id="headlessui-tabs-tab-:R2ir9m:" role="tab" type="button" aria-selected="true"
                                    tabindex="0" aria-controls="headlessui-tabs-panel-:r4:"><span
                    ...
                    <div class="relative rounded-2xl transition-colors hover:bg-gray-800/30">
                        <div class="relative z-10 p-8"><svg viewBox="0 0 32 32" aria-hidden="true" class="h-8 w-8">
                            ...
                            <h3 class="mt-6 text-lg font-semibold text-white"><button
                                    class="text-left "
                                    id="headlessui-tabs-tab-:R2kr9m:" role="tab" type="button" aria-selected="false"
                                    tabindex="-1"><span class="absolute inset-0 rounded-2xl"></span>Notifications on
                                    stock dips</button></h3>
                            <p class="mt-2 text-sm text-gray-400">Get a push notification every time we find out
                                something that’s going to lower the share price on your holdings so you can sell
                                before the information hits the public markets.</p>
                        </div>
                    ...
                    <div class="relative rounded-2xl transition-colors hover:bg-gray-800/30">
                        <div class="relative z-10 p-8"><svg viewBox="0 0 32 32" fill="none" aria-hidden="true"
                                class="h-8 w-8">
                                <defs>
                                    <linearGradient id=":R1mr9m:-gradient" x1="14" y1="14.5" x2="7" y2="17"
                                        gradientUnits="userSpaceOnUse">
                                        <stop stop-color="#737373"></stop>
                                        <stop offset="1" stop-color="#D4D4D4" stop-opacity="0"></stop>
                                    </linearGradient>
                                ...
                                <path fill-rule="evenodd" clip-rule="evenodd"
                                    d="M5 4a4 4 0 014-4h14a4 4 0 014 4v13h-2V4a2 2 0 00-2-2h-1.382a1 1 0 00-.894.553l-.448.894a1 1 0 01-.894.553h-6.764a1 1 0 01-.894-.553l-.448-.894A1 1 0 0010.382 2H9a2 2 0 00-2 2v24a2 2 0 002 2h4v2H9a4 4 0 01-4-4V4z"
                                    fill="#A3A3A3"></path>
                                <path d="M7 22c0-4.694 3.5-8 8-8" stroke="url(#:R1mr9m:-gradient)" stroke-width="2"
                                    stroke-linecap="round" stroke-linejoin="round"></path>
                                <path
                                    d="M21 20l.217-5.513a1.431 1.431 0 00-2.85-.226L17.5 21.5l-1.51-1.51a2.107 2.107 0 00-2.98 0 .024.024 0 00-.005.024l3.083 9.25A4 4 0 0019.883 32H25a4 4 0 004-4v-5a3 3 0 00-3-3h-5z"
                                    fill="#A3A3A3"></path>
                            ...
                            <h3 class="mt-6 text-lg font-semibold text-white"><button
                                    class="text-left "
                                    id="headlessui-tabs-tab-:R2mr9m:" role="tab" type="button" aria-selected="false"
                                    tabindex="-1"><span class="absolute inset-0 rounded-2xl"></span>Invest what you
                                    want</button></h3>
                            <p class="mt-2 text-sm text-gray-400">We hide your stock purchases behind thousands of
                                anonymous trading accounts, so suspicious activity can never be traced back to you.
                            </p>
                ...
                <div class="relative col-span-6">
                    <div class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
                        <svg viewBox="0 0 558 558"
                            ...
                            <path opacity=".2"
                                d="M1 279C1 125.465 125.465 1 279 1s278 124.465 278 278-124.465 278-278 278S1 432.535 1 279Z"
                                stroke="#13B5C8"></path>
                            <path d="M1 279C1 125.465 125.465 1 279 1" stroke="url(#:R3b9m:)" stroke-linecap="round">
                            </path>
                        </svg>
                    </div>
                    <div class="relative aspect-[366/729] z-10 mx-auto w-full max-w-[366px]">
                        ...
                        <div
                            class="absolute top-[calc(23/729*100%)] left-[calc(23/366*100%)] grid h-[calc(686/729*100%)] w-[calc(318/366*100%)] transform grid-cols-1 overflow-hidden bg-gray-900 pt-[calc(23/318*100%)]">
                            <div class="col-start-1 row-start-1 flex focus:outline-offset-[32px] "
                                id="headlessui-tabs-panel-:r4:" role="tabpanel" tabindex="0"
                        ...
                        <img alt="" src="/images/phone-frame.d4b6b62a.svg" width="366" height="729"
