                ...
                <div class="py-16">
                    ...
                    <nav class="mt-10 text-sm" aria-label="quick links">
                        <div class="-my-1 flex justify-center gap-x-6"><a
                                class="inline-block rounded-lg py-1 px-2 text-sm text-gray-300 hover:bg-slate-100 hover:text-slate-900"
                ...
                <div
                    ...
                    <div class="flex gap-x-6"><a class="group" aria-label="TaxPal on Twitter"
                            href="https://twitter.com"><svg aria-hidden="true"
                                class="h-6 w-6 fill-gray-300 group-hover:fill-slate-700">
                                <path
                                ...
                                aria-hidden="true" class="h-6 w-6 fill-gray-300 group-hover:fill-slate-700">
                                <path
                    ...
                    <p class="mt-6 text-sm text-gray-300 sm:mt-0">Copyright © 2022 QrCodify. All rights reserved.</p>
                </div>
            </div>
        </footer>
</template>