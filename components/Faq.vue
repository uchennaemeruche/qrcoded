<template>
    <div>
        <section id="faq" aria-labelledby="faq-title" class="relative overflow-hidden bg-white py-20 sm:py-32"><img
                alt="" src="/images/background-faqs.55d2e36a.jpg" width="1558" height="946" decoding="async"
                data-nimg="future" class="absolute top-0 left-1/2 max-w-none translate-x-[-30%] -translate-y-1/4"
                loading="lazy">
                ...
                <ul role="list" class="mx-auto mt-16 grid max-w-2xl grid-cols-1 gap-8 lg:max-w-none lg:grid-cols-3">
                    ...
                    <li>
                        <ul role="list" class="flex flex-col gap-y-8">
                            ...
                            <li>
                                <h3 class="font-display text-lg leading-7 text-slate-900">TaxPal sounds horrible but why
                            ...
                            <li>
                                <h3 class="font-display text-lg leading-7 text-slate-900">I found other companies called
